...
source.include_exts = py,png,jpg,kv,json,ttf,atlas,mp4
...
source.exclude_dirs = tests, bin, venv, android-sdk, .buildozer, .git, .github
...
android.presplash_color = #0D285A
...
android.permissions = INTERNET, RECORD_AUDIO, POST_NOTIFICATIONS, USE_BIOMETRIC, USE_FINGERPRINT
